...
# 24 "t1.c"
 ...
 exit(1);
    ...
    pthread_t p1, p2;
    printf("main: begin [counter = %d] [%lu]\n", counter,
    (uintptr_t) &counter);
...
# 32 "t1.c"
   "pthread_create(&p1, ((void *)0), mythread, \"A\") == 0"
# 32 "t1.c" 3 4
   , "t1.c", 32, __extension__ __PRETTY_FUNCTION__); }))
# 32 "t1.c"
   ;;
...
# 33 "t1.c"
   "pthread_create(&p2, ((void *)0), mythread, \"B\") == 0"
# 33 "t1.c" 3 4
   , "t1.c", 33, __extension__ __PRETTY_FUNCTION__); }))
# 33 "t1.c"
   ;;
...
# 35 "t1.c" 3 4
   , "t1.c", 35, __extension__ __PRETTY_FUNCTION__); }))
# 35 "t1.c"
   ;;
...
# 36 "t1.c" 3 4
   , "t1.c", 36, __extension__ __PRETTY_FUNCTION__); }))
# 36 "t1.c"
   ;;
    printf("main: done\n [counter: %d]\n [should: %d]\n",
    counter, max*2);
