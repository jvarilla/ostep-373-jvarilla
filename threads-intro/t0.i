...
# 21 "t0.c" 3 4
   , "t0.c", 21, __extension__ __PRETTY_FUNCTION__); }))
# 21 "t0.c"
   ;;
...
# 22 "t0.c" 3 4
   , "t0.c", 22, __extension__ __PRETTY_FUNCTION__); }))
# 22 "t0.c"
   ;;
...
# 24 "t0.c" 3 4
   , "t0.c", 24, __extension__ __PRETTY_FUNCTION__); }))
# 24 "t0.c"
   ;;
...
# 25 "t0.c" 3 4
   , "t0.c", 25, __extension__ __PRETTY_FUNCTION__); }))
# 25 "t0.c"
   ;;
    printf("main: end\n");
    return 0;
